...
static const short yyrline[] = { 0,
   152,   153,   156,   159,   162,   165,   168,   171,   174,   180,
   186,   193,   199,   209,   213,   217,   224,   228,   232,   238,
   242,   247,   253,   257,   262,   266,   273,   277,   280,   283,
   286,   289,   292,   295,   298,   301,   304,   309,   337,   340
};

static const char * const yytname[] = {   "$",
"error","$illegal.","tAGO","tDAY","tDAYZONE","tID","tMERIDIAN","tMINUTE_UNIT","tMONTH","tMONTH_UNIT",
"tSEC_UNIT","tSNUMBER","tUNUMBER","tZONE","tDST","':'","','","'/'","spec","item",
"time","zone","day","date","rel","relunit","number","o_merid",""
};
#endif
