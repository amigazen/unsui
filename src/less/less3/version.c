 ...
 *      v48.amiga 1.0: Port by Bob Leivian
 *          2702 W Curry Chander AZ 85224 602-820-6859 mot!dover!leivian
 *          amiga 1.1					4/30/87 Bob L.
 *          added templates, workbench access, fixed BS in searches,
 *	    and last space exits now
 *          amiga 1.2					8/9/87 Bob L.
 * 	    disabled the LESS environment variable so it will
 *          not require the workbench at each startup   
 *      -----------------------------------------------------------------
 */

char version[] =
 "Less 1.2 by Bob Leivian: <space> for more, b-ackup, h-elp, q-uit";
