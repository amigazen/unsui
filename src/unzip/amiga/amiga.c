...
const char version_id[] = "\0$VER: UnZip 5.52 " __DATE__ " AmigaOS 4 PPC\r\n";
#endif /* SFX */
    ...
    __GDEF
{
  ...
  /* set file perms after closing (not done at creation)--see mapattr() */
    ...
    chmod(G.filename, 0777); // G.pInfo->file_attr);    THIS IS AMIGA, WE DON'T HAVE SECURITY
