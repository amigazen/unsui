...
union record {
	...
	struct header {
		...
		char	devminor[8];
#ifdef AMIGA
		char	magic_cookie[9];	/* "AmigaTar" */
		char	amiga_modes[9];		/* Protection, hex ascii */
		char	comment[80];		/* Comment */
		char	ds_Days[9];		/* Date Stamp, hex ascii */
		char	ds_Minute[9];		/* Date Stamp, hex ascii */
		char	ds_Tick[9];		/* Date Stamp, hex ascii */
#endif
	} header;
};
 ...
 */
#ifdef AMIGA
TAR_EXTERN char f_archive_set;		/* -a */
TAR_EXTERN char f_archive_check;	/* -A */
#endif
