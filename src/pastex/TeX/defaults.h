...
#ifdef AMIGA
# define FILENAMESIZE	512	/* beware of config files.... */
#else
#ifndef FILENAMESIZE		/* (br) ANSI C defines FILENAME_MAX */
# ifdef FILENAME_MAX
#  define FILENAMESIZE FILENAME_MAX
# else
#  ifdef FMSIZE			/* (hes) for AMIGA LC */
#   define FILENAMESIZE FMSIZE
#  else
