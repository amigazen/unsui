%% grfguide.tex Copyright (C) 1994 1995 1996 David Carlisle
%%
...
For the keys specifying the original size (ie the bounding box, trim and
viewport keys) the units can be omitted, in
